...
const Radio = () => {
  return (
    <StyledWrapper>
      <div className="radio-inputs mr-35 ">
        <label>
          <input className="radio-input instagram" type="radio" name="engine" />
          <span className="radio-tile instagram">
            <span className="radio-icon">
              <svg className="instagram" fillRule="nonzero" height="30px" width="30px" viewBox="0,0,256,256" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
        ...
        <label>
          <input className="radio-input twitter" type="radio" name="engine" />
          <span className="radio-tile twitter">
            <span className="radio-icon">
